...
class EpsilonGreedy:
    ...
    def __init__(self, num_actions,
        ...
        :param end_value:
            Ending value for lnearly decreasing epsilon.
    ...
    def get_epsilon(self, iteration, training):
        """
        Return the epsilon for the given iterations.
    ...
    def get_action(self, q_values, iteration, training):
        ...
        if np.random.random() < epsilon:
            ...
            # Otherwise select the action that has the highest Q-values.
...
class NeuralNetwork:
    ...
    def __init__(self, num_actions, replay_memory):
        ...
        # Path for saving/restoring checkpionts.
