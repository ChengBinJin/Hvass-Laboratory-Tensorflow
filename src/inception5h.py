...
class Inception5h:
    # The Inception model is a Deep Neural Network which has alrady been
    ...
    def __init__(self):
        ...
        # doesthis is confusing and requires several steps.
        ...
        with self.graph.as_default():
            ...
            with tf.gfile.FastGFile(path, 'rb') as file:
                ...
                # Finally we import the graph-def to the default TensorFlwo graph.
    ...
    def create_feed_dict(self, image=None):
        ...
        #       The pixels MUST be values between 0 and 255 (flaot or int).
        # :return:
    ...
    def get_gradient(self, tensor):
        ...
        with self.graph.as_default():
            ...
            # Avearge the tensor so we get a single scalar value.
