...
class DataSet:
    def __init__(self, in_dir, exts='.jpg'):
        ...
        This mean there are 3 classes called: forky, knifey, and spoony.
        ...
        for name in os.listdir(in_dir):
            ...
            if os.path.isdir(current_dir):
                ...
                # Append them to the list of all class-numbers fo the training-set.
    ...
    def get_paths(self, test=False):
        ...
        :param test:
            Boolean. Return the paths for the test-set (Ture) or training-set (False).
    ...
    def get_test_set(self):
        ...
        and the list of clas-numbers as integers,
        and the class-numbers as one-hot encoded arrays.
        """
...
def load_cached(cache_path, in_dir):
    ...
    with Trasfer Values saved to another cache-file, see e.g.
